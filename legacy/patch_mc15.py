"""
Legacy patch: unify all archives to MC = 15.
1) Replace E1e with the Fixed-method data from method_comparison_results.json
2) Re-run E3d at MC = 15
3) Update paper_fullscale_results.json

Usage: 
  Place paper_fullscale_results.json and method_comparison_results.json
  in the same directory, then run:
  python3 patch_mc15.py

Output: paper_final_mc15.json (merged archive)
"""
import numpy as np
import json
import time
...
# ====================================================================
print("=" * 60)
print("Legacy patch: unify all archives to MC = 15.")
print("=" * 60)
...
# ====================================================================
# 2) Replace E1e with the Fixed-method cells from method_comparison
# ====================================================================
...
# Verification: check the values do not shift materially
...
# ====================================================================
# 4) Refit the model on the updated E1e data
# ====================================================================
